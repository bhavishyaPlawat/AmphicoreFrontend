...
function Hero() {
  return (
    <section className="w-full min-h-screen flex items-center overflow-hidden">
      <div className="w-full grid grid-cols-1 md:grid-cols-10 gap-10 items-center">
        {/* Left Column: Text Content */}
        <div className="text-content md:col-span-5 order-1 px-6 sm:px-12 lg:px-24 flex flex-col justify-center h-full">
          ...
          <p className="mt-8 text-lg md:text-xl text-black max-w-lg">
            The business apps your depend on, the support you deserve, and the
